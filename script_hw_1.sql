...
from
	students
where
	created_on = '2021-03-26 00:00:00'
...
from
	students
where
	"password" in('12333', '1m313', '123313')
...
from
	students
where
	created_on in('2020-10-03 00:00:00', '2021-05-19 00:00:00', '2021-03-26 00:00:00')
